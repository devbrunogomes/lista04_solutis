...
//atributos
    ...
    public Cachorro(String nome, String tipoAnimal, int idade, String habitat, int qntdDePatas, int altura, int peso) {
    ...
    public void getHorasDormidas() {
        System.out.println(this.nome + " dormiu um total de: " + this.horasDormidas + " hora(s)!");
    }
